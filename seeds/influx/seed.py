# FROM INFLUXDB docs
# https://www.influxdata.com/blog/write-millions-of-points-from-csv-to-influxdb-with-the-2-0-python-client/

# TO DO : How to import / download these libraries? Is there a package manager like npm for python?
...
class InfluxDBWriter(multiprocessing.Process):
    ...
    def __init__(self, queue):
        ...
        self.queue = queue
        self.client = InfluxDBClient(url="http://localhost:9999", token, org="my-org", debug=False)
